    ...
    b.extend(b.jgrid, {version: "4.5.2", htmlDecode: function(b) {
            ...
            if (f && null != f)
                if (!isNaN(f - 0) && "u" === ("" + d).toLowerCase())
                    ...
                    h = new Date(parseInt(j[1], 10)), j[3] &&
                            (d = 60 * Number(j[5]) + Number(j[6]), d *= "-" === j[4] ? 1 : -1, d -= h.getTimezoneOffset(), h.setTime(Number(Number(h) + 6E4 * d)));
                else {
                    f = ("" + f).replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe);
                    d = d.replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe);
                    i = 0;
                    for (k = d.length; i < k; i++)
                        "M" === d[i] && (j = b.inArray(f[i], e.monthNames), -1 !== j && 12 > j && (f[i] = j + 1, g.m = f[i])), "F" === d[i] && (j = b.inArray(f[i], e.monthNames, 12), -1 !== j && 11 < j && (f[i] = j + 1 - 12, g.m = f[i])), "a" === d[i] && (j = b.inArray(f[i], e.AmPm), -1 !== j && 2 > j && f[i] === e.AmPm[j] &&
            ...
            if ("function" ===
                ...
                return f(d);
            if (e && e[2])
                return e[1] ? b(e[1], d).attr(e[2]) : b(d).attr(e[2]);
            d = b(f, d);
            ...
            return new function(d, c) {
                ...
                if ("object" === typeof d && d.push)
                    0 < d.length && (A = "object" !== typeof d[0] ? !1 : !0);
                else
                        ...
                        if (a) {
                            ...
                            if (f) {
                                ...
                                if (k < a && 0 >= i && (void 0 === e.lastpage || parseInt((k + g + f - 1) / f, 10) <= e.lastpage))
                                    F = parseInt((a - k + f - 1) / f, 10), 0 <= k || 2 > F || !0 === e.scroll ? (z = Math.round((k + g) / f) + 1, i = -1) : i = 1;
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)
                        ...
                        var o = function(a, b) {
                            ...
                            if (b.isXMLDoc(c)) {
                                ...
                                if (a.p.gridview === true) {
                                    ...
                                    if (a.p.grouping) {
                                        ...
                                        a.p.treeGrid === true && G > 0 ? b(a.rows[G]).after(r.join("")) : b("tbody:first", d).append(r.join(""))
                                }
                                if (a.p.subGrid === true)
                                    try {
                            ...
                            if (b.isArray(a.p.data)) {
                                ...
                                b.each(a.p.colModel, function() {
                                    ...
                                    if (k === "date" || k === "datetime") {
                                        ...
                                        f[this.name] = {stype: k, srcfmt: "", newfmt: ""};
                                    if (a.p.grouping) {
                                        m = 0;
                                ...
                                if (a.p.treeGrid)
                                    b(a).jqGrid("SortTree", d, a.p.sortorder, f[d].stype,
                                            f[d].srcfmt);
                                else {
                                    var p = {eq: function(a) {
                                            return a.equals
                            ...
                            if (a.p.rowList.length > 0) {
                                ...
                                for (k = 0; k < a.p.rowList.length; k++)
                                    i = i + ('<option role="option" value="' + a.p.rowList[k] + '"' + (a.p.rowNum === a.p.rowList[k] ? ' selected="selected"' : "") + ">" + a.p.rowList[k] + "</option>");
                                i = i + "</select></td>"
                            }
                            f === "rtl" && (g = g + i);
                        ...
                        if (a.p.multiSort) {
                            ...
                            for (g = 0; g < ba.length; g++)
                                C = b.trim(ba[g]).split(" "), ba[g] = b.trim(C[0]), pa[g] = C[1] ? b.trim(C[1]) : a.p.sortorder || "asc"
                        }
                        for (g = 0; g < this.p.colNames.length; g++)
                            C = a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[g]) + '"' : "", B += "<th id='" + a.p.id + "_" + a.p.colModel[g].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + f + "'" + C + ">", C = a.p.colModel[g].index ||
                        ...
                        (function() {
                            ...
                            if (isNaN(a.p.width))
                                a.p.width = d + (a.p.shrinkToFit === false && !isNaN(a.p.height) ? h : 0);
                            c.width = a.p.width;
                            a.p.tblwidth = d;
                        ...
                        b(a).before(c.hDiv).click(function(c) {
                            ...
                            if (b(p).length ===
                                    0 || p[0].className.indexOf("ui-state-disabled") > -1 || (b(v, a).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== a.id)
                                return this;
    ...
    b.jgrid.extend({getGridParam: function(b) {
            ...
            this.each(function() {
                if ((c = this.rows.length) && 0 < c)
                    for (; f < c; )
                        b(this.rows[f]).hasClass("jqgrow") && (d[e] = this.rows[f].id, e++), f++
            });
            return d
                ...
                if (void 0 !== d && (f = !1 ===
                    ...
                    if (!0 === this.p.scrollrows && (j = this.rows.namedItem(d).rowIndex, 0 <= j && (e = b(this.grid.bDiv)[0].clientHeight, g = b(this.grid.bDiv)[0].scrollTop, h = b(this.rows[j]).position().top, j = this.rows[j].clientHeight, h + j >= e + g ? b(this.grid.bDiv)[0].scrollTop = h - (e + g) + j + g : h < e + g && h < g && (b(this.grid.bDiv)[0].scrollTop = h))), !0 === this.p.frozenColumns && (i = this.p.id + "_frozen"), this.p.multiselect) {
                        if (this.setHeadCheckBox(!1), this.p.selrow =
                                ...
                                "#" + b.jgrid.jqID(i)).addClass("ui-state-highlight") : b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(i)).removeClass("ui-state-highlight"), b("#jqg_" + b.jgrid.jqID(this.p.id) + "_" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(i))[this.p.useProp ? "prop" : "attr"]("checked", e)), f)
                            b(this).triggerHandler("jqGridSelectRow", [a.id, e, c]), this.p.onSelectRow && this.p.onSelectRow.call(this, a.id, e, c)
                        ...
                        tabindex: "-1"}), b(a).addClass("ui-state-highlight").attr({"aria-selected": "true", tabindex: "0"}), i && (b("#" + b.jgrid.jqID(this.p.selrow), "#" + b.jgrid.jqID(i)).removeClass("ui-state-highlight"), b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(i)).addClass("ui-state-highlight")), e = !0) : e = !1, this.p.selrow = a.id, f))
                        b(this).triggerHandler("jqGridSelectRow", [a.id, e, c]), this.p.onSelectRow && this.p.onSelectRow.call(this, a.id, e, c)
            })
            ...
            return this.each(function() {
                ...
                if (void 0 !== d) {
                    ...
                    if (f.p.multiselect) {
                        ...
                        if (a)
                            b("#jqg_" + b.jgrid.jqID(f.p.id) + "_" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(a))[f.p.useProp ? "prop" :
                                    "attr"]("checked", !1);
                        f.setHeadCheckBox(!1)
                    }
                    e = null
                } else
                    f.p.multiselect ? (b(f.p.selarrrow).each(function(d, e) {
            ...
            this.each(function() {
                ...
                for (; j < a; )
                    e && (i = g.rows[j]), b(i).hasClass("jqgrow") && (b('td[role="gridcell"]', i).each(function(a) {
                        ...
                        if (b(this.p.colModel).each(function(a) {
                            ...
                            if (g.p.treeGrid)
                                for (m in g.p.treeReader)
                                    g.p.treeReader.hasOwnProperty(m) &&
                                            delete l[g.p.treeReader[m]];
                ...
                if (c.grid) {
                    ...
                    b(this.p.colModel).each(function(h) {
                        if (-1 !== b.inArray(this.name, d) && this.hidden === g) {
                            if (!0 ===
                                    c.p.frozenColumns && !0 === this.frozen)
                                return!0;
                    ...
                    if (!isNaN(d)) {
                        ...
                        if (!0 === f) {
                            ...
                            if (!isNaN(c.p.height) && (b(c.grid.bDiv)[0].clientHeight <
                                    b(c.grid.bDiv)[0].scrollHeight || 1 === c.rows.length))
                                i = !0, l -= k;
            ...
            return this.each(function() {
                ...
                if (this.grid && (isNaN(f) ? b(this.p.colModel).each(function(a) {
                    ...
                    var k = b("td:eq(" + g + ")", h);
                    if ("" !== c || !0 === j)
                        h = this.formatter(d, c, g, h, "edit"), i = this.p.colModel[g].title ? {title: b.jgrid.stripHtml(h)} : {}, this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length ? b("span", b(k)).html(h).attr(i) : b(k).html(h).attr(i), "local" === this.p.datatype && (h = this.p.colModel[g], c = h.formatter && "string" === typeof h.formatter && "date" === h.formatter ?
                ...
                b(c).keydown(function(d) {
                    ...
                    if (a)
                        if (h = c.p._index[b.jgrid.stripPref(c.p.idPrefix, a.id)], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
                            ...
                            13 === d.keyCode ? (b(c).triggerHandler("jqGridKeyEnter", [c.p.selrow]), b.isFunction(f.onEnter) && f.onEnter.call(c, c.p.selrow)) : 32 === d.keyCode && (b(c).triggerHandler("jqGridKeySpace", [c.p.selrow]),
    ...
    a.fn.fmatter.select = function(c, b) {
        ...
        if (d) {
            ...
            if (a.fmatter.isString(d)) {
                ...
                a.fmatter.isObject(d) && (h ? e = a.map(j, function(a) {
                    return d[a]
                }) : e[0] = d[c] || "")
        }
        c = e.join(", ");
    ...
    a.jgrid.extend({getColProp: function(a) {
        ...
        setGridState: function(b) {
                ...
                if (!this.ftoolbar) {
                    var f = function() {
                        ...
                        a.each(c.p.colModel, function() {
                            ...
                            if ((f = "custom" === this.stype && a.isFunction(this.searchoptions.custom_value) && 0 < i.length && "SPAN" === i[0].nodeName.toUpperCase() ? this.searchoptions.custom_value.call(c, i.children(".customelement:first"), "get") : i.val()) || "nu" === n || "nn" === n)
                                e[l] = f, j[l] = n, d++;
                            else
                                try {
                        ...
                        o || a(c).jqGrid("setGridParam", {search: i}).trigger("reloadGrid", [{page: 1}]);
                        ...
                        for (i = 0; i < k.sopt.length; i++)
                            n = a.inArray(k.sopt[i], h), -1 !== n && (l = j === b.odata[n].oper ? "ui-state-highlight" : "", d += '<li class="ui-menu-item ' + l + '" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[n].oper +
                            ...
                            switch (this.stype) {
                                case "select":
                                    if (g = this.surl || d.dataUrl)
                                        a.ajax(a.extend({url: g, dataType: "html", success: function(g) {
                                        ...
                                        if (m) {
                                            ...
                                            if ("string" === typeof m) {
                                                ...
                                                for (q = 0; q < g.length; q++)
                                                    m = g[q].split(r), o = document.createElement("option"), o.value = m[0], o.innerHTML = m[1], l.appendChild(o)
                                ...
                                case "custom":
                                    ...
                                    try {
                                        if (a.isFunction(d.custom_element)) {
                                            ...
                                            if (u)
                                                u = a(u).addClass("customelement"), a(i).find(">span").append(u);
                                            else
                                                throw"e2";
                                        } else
                                            throw"e1";
                    ...
                    this.clearToolbar =
                            function(e) {
                                ...
                                m || e && a(c).jqGrid("setGridParam",
                                        {search: j}).trigger("reloadGrid", [{page: 1}]);
            ...
            return this.each(function() {
                ...
                for (c = 0; c < s; c++)
                    if (e = n[c].el, d = a(e), f = l[c], h = {height: "0px", width: n[c].width + "px", display: f.hidden ? "none" : ""}, a("<th>",
                        ...
                        0 === g ? b.useColSpanStyle ? d.attr("rowspan", "2") : (a("<th>", {role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({display: f.hidden ? "none" : "", "border-top": "0px none"}).insertBefore(d), j.append(e)) : (j.append(e), g--);
...
(function(a) {
    a.extend(a.jgrid, {showModal: function(a) {
            ...
            if (a.fn.jqm && !0 === c.jqModal)
                0 === c.left && 0 === c.top && c.overlay && (f = [], f = a.jgrid.findPos(e), c.left = f[0] + 4, c.top = f[1] + 4), b.top = c.top + "px", b.left =
                        c.left;
            else if (0 !== c.left || 0 !== c.top)
                b.left = c.left, b.top = c.top + "px";
            ...
            if (c.resize)
                if (a.fn.jqResize)
                    a(i).append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se'></div>"), a("#" + a.jgrid.jqID(d.themodal)).jqResize(".jqResize", d.scrollelm ? "#" + a.jgrid.jqID(d.scrollelm) : !1);
                else
                    try {
            ...
            switch (d) {
                ...
                case "select":
                    ...
                    !0 === b.multiple ? (d = !0, f.multiple = "multiple", a(f).attr("aria-multiselectable", "true")) :
                            d = !1;
                    if (void 0 !== b.dataUrl)
                        d = b.name ? ("" + b.id).substring(0, ("" + b.id).length - ("" + b.name).length - 1) : "" + b.id, g = b.postData || e.postData, i.p && i.p.idPrefix ? d = a.jgrid.stripPref(i.p.idPrefix, d) : g = void 0, a.ajax(a.extend({url: b.dataUrl, type: "GET", dataType: "html", data: a.isFunction(g) ? g.call(i, d, c, "" + b.name) : g, context: {elem: f, options: b, vl: c}, success: function(d) {
                    ...
                    try {
                        if (a.isFunction(b.custom_element))
                            if (l = b.custom_element.call(i, c, b))
                                l = a(l).addClass("customelement").attr({id: b.id, name: b.name}), a(f).empty().append(l);
                            else
                                throw"e2";
                        else
                            throw"e1";
            ...
            for (i = 0; i < a.length; i++)
                e = isNaN(b[i]) ? 0 : parseInt(b[i], 10), c[a[i]] = e, e = a[i], -1 !== e.indexOf("y") && (g = i), -1 !== e.indexOf("m") && (f = i), -1 !== e.indexOf("d") && (h = i);
            ...
            var b = /^(\d{1,2})(\d{2})([apAP][Mm])?$/; //MODIFICADO var b = /^(\d{1,2}):(\d{2})([apAP][Mm])?$/;
            ...
            if (e) {
                ...
                if (!0 === e.date && !(!1 === c && a.jgrid.isEmpty(d)) && (f[b].formatoptions && f[b].formatoptions.newformat ? (f = f[b].formatoptions.newformat, a.jgrid.formatter.date.masks.hasOwnProperty(f) && (f = a.jgrid.formatter.date.masks[f])) : f = f[b].datefmt || "Y-m-d", !a.jgrid.checkDate(f, d)))
                    return[!1, h + ": " + a.jgrid.edit.msg.date + " - " +
                                f, ""];
                if (!0 === e.time && !(!1 === c && a.jgrid.isEmpty(d)) && !a.jgrid.checkTime(d))
                    return[!1, h + ": " + a.jgrid.edit.msg.date + " - hhmm ", ""]; //MODIFICADO return[!1, h + ": " + a.jgrid.edit.msg.date + " - hh:mm (am/pm)", ""];
    ...
    a.jgrid.extend({searchGrid: function(b) {
            ...
            return this.each(function() {
                ...
                if (e.grid) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(u.themodal))[0])
                        ...
                        b.columns.length ? (n = b.columns, p = 0, o = n[0].index || n[0].name) : a.each(n, function(a,
                                b) {
                            if (!b.label)
                        ...
                        if (!s && o || !1 === b.multipleSearch) {
                            ...
                            s = {groupOp: "AND", rules: [{field: o, op: y, data: ""}]}
                        }
                        k = !1;
            ...
            return this.each(function() {
                ...
                function i(c, e, l, g) {
                    ...
                    if (0 < p && (r = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * g - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + e.p.id + "_id' value='" + c + "'/></td></tr>"), r[0].rp = p + 999, a(l).append(r), b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate))
                    ...
                    if ("_empty" === c)
                        a(m).each(function() {
                            ...
                            if ((j = a("#" + a.jgrid.jqID(l), "#" + f)) && j.length && null !== j[0])
                                if (p = "", i.defaultValue ? (p = a.isFunction(i.defaultValue) ? i.defaultValue.call(d) : i.defaultValue, "checkbox" === j[0].type ? (r = p.toLowerCase(), 0 > r.search(/(false|f|0|no|n|off|undefined)/i) && "" !== r ? (j[0].checked = !0, j[0].defaultChecked = !0, j[0].value = p) : (j[0].checked = !1, j[0].defaultChecked = !1)) : j.val(p)) : "checkbox" ===
                                        j[0].type ? (j[0].checked = !1, j[0].defaultChecked = !1, p = a(j).attr("offval")) : j[0].type && "select" === j[0].type.substr(0, 6) ? j[0].selectedIndex = 0 : j.val(p), !0 === b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate)
                                    ...
                                    case "checkbox":
                                        ...
                                        if (m[j].editoptions && m[j].editoptions.value)
                                            if (m[j].editoptions.value.split(":")[0] === g)
                                                a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]({checked: !0, defaultChecked: !0});
                                            else
                                                a("#" +
                                                        l, "#" + f)[d.p.useProp ? "prop" : "attr"]({checked: !1, defaultChecked: !1});
                                        else
                                            g = g.toLowerCase(), 0 > g.search(/(false|f|0|no|n|off|undefined)/i) && "" !== g ? (a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("checked", !0), a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("defaultChecked", !0)) : (a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("checked", !1), a("#" + l, "#" + f)[d.p.useProp ? "prop" : "attr"]("defaultChecked", !1));
                                        break;
                                    case "custom":
                                        try {
                                            if (m[j].editoptions && a.isFunction(m[j].editoptions.custom_value))
                                                m[j].editoptions.custom_value.call(d,
                                                        a("#" + l, "#" + f), "set", g);
                                            else
                                                throw"e1";
                                        } catch (p) {
                ...
                function s() {
                    ...
                    if (l[0] && !b[d.p.id].processing) {
                        ...
                        if (!0 === d.p.treeGrid)
                            for (n in j[m] === h.addoper && (o =
                                    a(d).jqGrid("getGridParam", "selrow"), j["adjacency" === d.p.treeGridModel?d.p.treeReader.parent_id_field:"parent_id"] = o), d.p.treeReader)
                        ...
                        n = a.extend({url: b[d.p.id].url || a(d).jqGrid("getGridParam", "editurl"), type: b[d.p.id].mtype, data: a.isFunction(b[d.p.id].serializeEditData) ? b[d.p.id].serializeEditData.call(d, j) : j, complete: function(g,
                                    r) {
                                var n;
                                ...
                                if (l[0] === false) {
                                    ...
                                    if (j[m] === h.addoper) {
                                        ...
                                        if (b[d.p.id].reloadAfterSubmit) {
                                            ...
                                            d.p.treeGrid === true ? a(d).jqGrid("setTreeRow", j[i], j) : a(d).jqGrid("setRowData", j[i], j);
                        ...
                        !n.url &&
                                !b[d.p.id].useDataProxy && (a.isFunction(d.p.dataProxy) ? b[d.p.id].useDataProxy = !0 : (l[0] = !1, l[1] += " " + a.jgrid.errors.nourl));
                ...
                function h() {
                    ...
                    if (b[d.p.id].checkOnUpdate && (j = {}, e(), K = m(j, b[d.p.id]._savedData)))
                        a("#" + f).data("disabled", !0), a(".confirm", "#" + p.themodal).show(), c = !1;
                    return c
                }
                function g() {
                    var c;
                ...
                if (d.grid && r) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
                        ...
                        if (b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate)
                            H = "<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + c.bYes + "</a>", D = "<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + c.bNo +
            ...
            return this.each(function() {
                ...
                function i(b, d, e, g) {
                    ...
                    for (o = 1; o <= g; o++)
                        s += 1 === o ? q : "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";
                    a(d.p.colModel).each(function() {
                                ...
                                if (f[0])
                                    if (b[e.p.id].useDataProxy) {
                                        ...
                                        if (h[0] === false) {
                                            ...
                                            a.jgrid.hideModal("#" + a.jgrid.jqID(o.themodal), {gb: "#gbox_" + a.jgrid.jqID(s), jqm: c.jqModal, onClose: b[e.p.id].onClose})
                                    } else
                                        a.ajax(h)
                            }
                            if (f[0] === false) {
                        ...
                        for (x = 0; x < n; x++) {
                            ...
                            c.edit &&
                                    (g = a("<td class='ui-pg-button ui-corner-all'></td>"), e = e || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.editicon + "'></span>" + c.edittext + "</div>"), a("tr", f).append(g), a(g, f).attr({title: c.edittitle || "", id: e.id || "edit_" + k}).click(function() {
                                        if (!a(this).hasClass("ui-state-disabled")) {
                                            var b = h.p.selrow;
                                            if (b)
                                                a.isFunction(c.editfunc) ? c.editfunc.call(h, b) : a(h).jqGrid("editGridRow", b, e);
                                            else {
                            ...
                            c.view && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), s = s || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.viewicon + "'></span>" + c.viewtext + "</div>"), a("tr", f).append(g), a(g, f).attr({title: c.viewtitle || "", id: s.id || "view_" + k}).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var b = h.p.selrow;
                                    if (b)
                                        a.isFunction(c.viewfunc) ? c.viewfunc.call(h, b) : a(h).jqGrid("viewGridRow", b, s);
                                    else {
                                        a.jgrid.viewModal("#" + m.themodal, {gbox: "#gbox_" + a.jgrid.jqID(h.p.id), jqm: true});
                                        a("#jqg_alrt").focus()
                                    }
                            ...
                            c.del && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), t = t || {}, a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.delicon + "'></span>" + c.deltext + "</div>"), a("tr", f).append(g), a(g, f).attr({title: c.deltitle || "", id: t.id || "del_" + k}).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    ...
                                    if (h.p.multiselect) {
                                        ...
                                        b = h.p.selrow;
                                    if (b)
                                        a.isFunction(c.delfunc) ? c.delfunc.call(h, b) : a(h).jqGrid("delGridRow",
                                                b, t);
                                    else {
                                        a.jgrid.viewModal("#" + m.themodal, {gbox: "#gbox_" + a.jgrid.jqID(h.p.id), jqm: true});
                                        a("#jqg_alrt").focus()
                            ...
                            c.refresh && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.refreshicon + "'></span>" + c.refreshtext + "</div>"), a("tr", f).append(g), a(g, f).attr({title: c.refreshtitle ||
                                ...
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    ...
                                    switch (c.refreshstate) {
                                        case "firstpage":
                                            a(h).trigger("reloadGrid", [{page: 1}]);
                                            break;
                                        case "current":
                                            a(h).trigger("reloadGrid", [{current: true}])
                                    }
            ...
            return this.each(function() {
                ...
                if (e.grid) {
                    ...
                    if (t)
                        for (i in t)
                            t.hasOwnProperty(i) && (a("[name=" + a.jgrid.jqID(i) + "]", c).is("input:radio") || a("[name=" + a.jgrid.jqID(i) + "]", c).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(i) + "]", c).each(function() {
                                if (a(this).val() == t[i])
                ...
                if (l) {
                    for (d = 0; d < l; d++)
                        if (f = this.p.columns[d], f.stype ? f.inputtype = f.stype : f.inputtype || (f.inputtype = "text"),
                                f.sorttype ? f.searchtype = f.sorttype : f.searchtype || (f.searchtype = "string"), void 0 === f.hidden && (f.hidden = !1), f.label || (f.label = f.name), f.index && (f.name = f.index), f.hasOwnProperty("searchoptions") || (f.searchoptions = {}), !f.hasOwnProperty("searchrules"))
                            f.searchrules = {};
                    ...
                    this.createTableForGroup = function(g, j) {
                        ...
                        if (!0 === this.p.ruleButtons) {
                            ...
                            for (c = 0; c < n.groupOps.length; c++)
                                i = g.groupOp === b.p.groupOps[c].op ? " selected='selected'" : "", h += "<option value='" + b.p.groupOps[c].op + "'" + i + ">" + b.p.groupOps[c].text + "</option>";
                        ...
                        if (void 0 !==
                            ...
                            for (c = 0; c < g.groups.length; c++)
                                e = a("<tr></tr>"), k.append(e), h = a("<td class='first'></td>"), e.append(h), h = a("<td colspan='4'></td>"), h.append(this.createTableForGroup(g.groups[c], g)), e.append(h);
                    ...
                    this.createTableRowForRule = function(g, j) {
                        ...
                        l.bind("change", function() {
                            ...
                            if (i) {
                                ...
                                for (e = 0; e < h.length; e++)
                                    o = a.inArray(h[e], q), -1 !== o && (0 === k && (g.op = b.p.ops[o].oper), j += "<option value='" + b.p.ops[o].oper + "'>" + b.p.ops[o].text + "</option>", k++);
                        ...
                        for (e = m = 0; e < b.p.columns.length; e++) {
                            ...
                            if (!0 === b.p.columns[e].searchoptions.searchhidden && p || p && !r)
                                p = "", g.field === b.p.columns[e].name && (p = " selected='selected'", m = e), d += "<option value='" + b.p.columns[e].name + "'" + p + ">" + b.p.columns[e].label + "</option>"
                        }
                        l.append(d);
                        ...
                        if ("nu" === g.op || "nn" === g.op)
                            a(m).attr("readonly", "true"), a(m).attr("disabled", "true");
                        ...
                        for (e = 0; e < h.length; e++)
                            o = a.inArray(h[e], q), -1 !== o && (p = g.op === b.p.ops[o].oper ? " selected='selected'" : "", d += "<option value='" + b.p.ops[o].oper + "'" + p + ">" + b.p.ops[o].text + "</option>");
                        s.append(d);
                        ...
                        function a(b) {
                            ...
                            if (void 0 !== b.groups)
                                for (f = 0; f < b.groups.length; f++)
                                    1 < c.length && (c = "OR" === b.groupOp ? c + " || " : c + " && "), c += a(b.groups[f]);
                            if (void 0 !==
                                    b.rules)
    ...
    a.jgrid.extend({editRow: function(c, b, e, o, l, g, n, h, f) {
            ...
            return this.each(function() {
                ...
                if (d.grid && (g = a(d).jqGrid("getInd", c, !0), !1 !== g && "0" === (a(g).attr("editable") || "0") && !a(g).hasClass("not-editable-row")))
                    k = d.p.colModel, a('td[role="gridcell"]', g).each(function(g) {
                        b = k[g].name;
            ...
            if ("object" === a.type(h[0]))
                f = h[0];
                    ...
                    (f.successfunc = b), void 0 !== e && (f.url = e), void 0 !== o && (f.extraparam = o), a.isFunction(l) && (f.aftersavefunc = l), a.isFunction(g) && (f.errorfunc = g), a.isFunction(n))
            ...
            if ("1" === h) {
                        ...
                        switch (k.edittype) {
                            ...
                            case "select":
                                if (k.editoptions.multiple) {
                                    ...
                                    i[m] = a("select option:selected", this).val(), w[m] = a("select option:selected", this).text();
                ...
                if (i) {
                    ...
                    if (void 0 === i[p] || "" === i[p])
                        i[p] = c;
                    else if (q.id !== d.p.idPrefix + i[p] && (h = a.jgrid.stripPref(d.p.idPrefix, c), void 0 !== d.p._index[h] &&
                            (d.p._index[i[p]] = d.p._index[h], delete d.p._index[h]), c = d.p.idPrefix + i[p], a(q).attr("id", c), d.p.selrow === u && (d.p.selrow = c), a.isArray(d.p.selarrrow) && (h = a.inArray(u, d.p.selarrrow), 0 <= h && (d.p.selarrrow[h] = c)), d.p.multiselect))
                        h = "jqg_" + d.p.id + "_" + c, a("input.cbox", q).attr("id", h).attr("name", h);
                ...
                if ("clientArray" === f.url) {
                    ...
                    a("#lui_" + a.jgrid.jqID(d.p.id)).show(), r = a.extend({}, i, r), r[p] = a.jgrid.stripPref(d.p.idPrefix, r[p]), a.ajax(a.extend({url: f.url, data: a.isFunction(d.p.serializeRowData) ? d.p.serializeRowData.call(d,
                            ...
                            if ("success" === g) {
                                ...
                                if (!0 === e) {
                                    ...
                                    a(d).triggerHandler("jqGridInlineErrorSaveRow", [c, b, g, null, f]), a.isFunction(f.errorfunc) && f.errorfunc.call(d, c, b, g, null), !0 === f.restoreAfterError && a(d).jqGrid("restoreRow", c, f.afterrestorefunc)
                            }
                        ...
                        switch (i.edittype) {
                            case "select":
                                if (i.editoptions.multiple) {
                                    ...
                                    e = b("#" + d + "_" + j + " option:selected", a.rows[d]).val(), h = b("#" + d + "_" + j + " option:selected", a.rows[d]).text();
                                i.formatter && (h = e);
                                break;
                            case "checkbox":
                                var l = ["Yes", "No"];
                            ...
                            if (!0 === p[0]) {
                                ...
                                if ("remote" === a.p.cellsubmit)
                                    if (a.p.cellurl) {
                                        ...
                                        b.ajax(b.extend({url: a.p.cellurl, data: b.isFunction(a.p.serializeCellData) ? a.p.serializeCellData.call(a, m) : m, type: "POST", complete: function(c,
                                                    i) {
                                                b("#lui_" + a.p.id).hide();
                                                a.grid.hDiv.loading = false;
                                                if (i === "success") {
                ...
                if (a.grid) {
                    var m = function(c, e, h) {
                        ...
                        for (f = 0; f < a.p.subGridModel[0].name.length; f++)
                            h = b("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-" + a.p.direction + "'></th>"), b(h).html(a.p.subGridModel[0].name[f]), b(h).width(a.p.subGridModel[0].width[f]), b(i).append(h);
                        b(d).append(i);
                        ...
                        for (f = 0; f < a.p.subGridModel[0].name.length; f++)
                            h = b("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-" + a.p.direction + "'></th>"), b(h).html(a.p.subGridModel[0].name[f]), b(h).width(a.p.subGridModel[0].width[f]), b(j).append(h);
                        b(k).append(j);
                    ...
                    for (; o < s; )
                        b(a.rows[o]).hasClass("jqgrow") && b(a.rows[o].cells[e]).bind("click",
                                function() {
...
(function(d) {
    ...
    d.jgrid.extend({groupingSetup: function() {
                ...
                if (null !== a && ("object" === typeof a ||
                    ...
                    if (a.groupField.length) {
                        ...
                        for (b = 0; b < a.groupField.length; b++)
                            a.groupOrder[b] || (a.groupOrder[b] = "asc"), a.groupText[b] || (a.groupText[b] = "{0}"), "boolean" !== typeof a.groupColumnShow[b] && (a.groupColumnShow[b] = !0), "boolean" !== typeof a.groupSummary[b] && (a.groupSummary[b] = !1), !0 === a.groupColumnShow[b] ? (a.visibiltyOnNextGrouping[b] = !0, d(this).jqGrid("showCol", a.groupField[b])) : (a.visibiltyOnNextGrouping[b] =
                                    d("#" + d.jgrid.jqID(this.p.id + "_" + a.groupField[b])).is(":visible"), d(this).jqGrid("hideCol", a.groupField[b]));
                        a.summary = [];
                        b = 0;
                        for (g = f.length; b < g; b++)
                            f[b].summaryType && a.summary.push({nm: f[b].name, st: f[b].summaryType, v: "", sr: f[b].summaryRound, srt: f[b].summaryRoundType || "round"})
                    } else
                        this.p.grouping = !1;
                else
                    this.p.grouping = !1
            ...
            this.each(function() {
                ...
                for (c = 0; c < k; c++)
                    l = e.groupField[c], m = e.displayField[c],
            ...
            this.each(function() {
                ...
                if (k.hasClass(e)) {
                    if (g.showSummaryOnHide) {
                        if (c)
                            for (; c && !(d(c).hasClass("jqfoot") &&
                                    parseInt(d(c).attr("jqfootlevel"), 10) <= a); )
                                d(c).hide(), c = c.nextSibling
                    } else if (c)
                        for (; c; ) {
            ...
            return this.each(function() {
                ...
                for (a = 0; a < f.groupField.length; a++)
                    !f.groupColumnShow[a] && f.visibiltyOnNextGrouping[a] &&
            ...
            return this.each(function() {
                ...
                if (!0 === b) {
                    ...
                    for (f = 0; f < g.groupField.length; f++)
                        !g.groupColumnShow[f] && g.visibiltyOnNextGrouping[f] && d(this).jqGrid("showCol",
                                g.groupField);
            ...
            return this.each(function() {
                ...
                if (a.grid && a.p.treeGrid)
                    for (var h = a.p.expColInd, e = a.p.treeReader.expanded_field, i = a.p.treeReader.leaf_field, g = a.p.treeReader.level_field, f = a.p.treeReader.icon_field, l = a.p.treeReader.loaded, k, m, n, j; b < c; )
                        j = d.jgrid.stripPref(a.p.idPrefix, a.rows[b].id), j = a.p.data[a.p._index[j]], "nested" === a.p.treeGridModel && !j[i] && (k = parseInt(j[a.p.treeReader.left_field], 10), m = parseInt(j[a.p.treeReader.right_field], 10), j[i] =
                ...
                if (a.grid && a.p.treeGrid)
                    switch (a.p.treeGridModel) {
                        ...
                        case "adjacency":
                            ...
                            d(this.p.data).each(function() {
                                if (this[m] ===
                                        d.jgrid.stripPref(a.p.idPrefix, b[k]))
                                    return c = this, !1
                            })
                        }
            });
        ...
        SortTree: function(b, c, a, h) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    for (i = k.length; e < i; e++)
                        g = k[e], f.push(g), d(this).jqGrid("collectChildrenSortTree", f, g, b, c, a, h);
                    d.each(f, function(a) {
            ...
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    for (f = k.length; g < f; g++)
                        l = k[g], b.push(l), d(this).jqGrid("collectChildrenSortTree", b, l, a, h, e, i)
                }
            })
            ...
            if (a) {
                ...
                if (void 0 === b || null === b) {
                    ...
                    if (0 <= p)
                        for (; 0 <= p; )
                            j = Math.max(j, parseInt(e.p.data[p][e.p.localReader.id],
                                    10)), p--;
                    b = j + 1
                }
                ...
                if (void 0 === c || null === c || "" === c)
                    s = c = null, j = "last", t = e.p.tree_root_level, p = e.p.data.length + 1;
                else if (j = "after", r = e.p._index[c], q = e.p.data[r], c = q[e.p.localReader.id], t = parseInt(q[f], 10) + 1, p = d(e).jqGrid("getFullTreeNode", q), p.length ? (s = p = p[p.length - 1][e.p.localReader.id], p = d(e).jqGrid("getInd", s) + 1) : p = d(e).jqGrid("getInd", c) + 1, q[g])
                    u = !0, q[i] = !0, d(e.rows[v]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(e.p.treeIcons.leaf +
                ...
                if ("nested" === e.p.treeGridModel) {
                    ...
                    if (null !== c) {
                        ...
                        if (f.length)
                            for (o in f)
                                f.hasOwnProperty(o) && (f[o][k] = f[o][k] > g ? parseInt(f[o][k], 10) + 2 : f[o][k], f[o][m] = f[o][m] >= g ? parseInt(f[o][m], 10) +
                                        2 : f[o][m]);
                        a[k] = g;
                        a[m] = g + 1
                    } else {
                ...
                if (null === c || d(e).jqGrid("isNodeLoaded", q) || u)
                    d(e).jqGrid("addRowData", b, a, j, s), d(e).jqGrid("setTreeNode", p, r);
                q && !q[i] &&
...
var xmlJsonClass = {xml2json: function(a, b) {
        ...
        var g = function(a, b, e) {
            ...
            if (a instanceof Array)
                ...
                if (f) {
                    for (i in a)
                        a.hasOwnProperty(i) && ("#text" === i ? d += a[i] : "#cdata" === i ? d += "<![CDATA[" + a[i] + "]]\>" : "@" !== i.charAt(0) && (d += g(a[i], i, e + "\t")));
                    d += ("\n" === d.charAt(d.length - 1) ? e : "") + "</" + b + ">"
                }
            } else
                "function" === typeof a ? d += e + "<" + b + "><![CDATA[" + a + "]]\></" + b + ">" : (void 0 === a && (a = ""), d = '""' === a.toString() || 0 === a.toString().length ? d + (e + "<" + b + ">__EMPTY_STRING_</" + b + ">") : d + (e + "<" + b + ">" + a.toString() + "</" + b + ">"));
            return d
        }, f = "", e;
        for (e in a)
            a.hasOwnProperty(e) &&
        ...
        if (1 === a.nodeType) {
            ...
            if (a.firstChild) {
                ...
                if (h)
                    ...
                    a.attributes.length ? b["#text"] = this.escape(this.innerXml(a)) :
        ...
        if ("[]" === a)
            ...
            e = "string" === typeof a ? e + ((b && ":") + '"' + a.replace(/\\/g,
        ...
        if ("innerHTML"in a)
            ...
            for (var g = function(a) {
                ...
                if (1 === a.nodeType) {
                    ...
                    3 === a.nodeType ? b += a.nodeValue : 4 === a.nodeType && (b += "<![CDATA[" + a.nodeValue +
                            "]]\>");
                return b
    ...
    b.jgrid.extend({sortableColumns: function(a) {
            return this.each(function() {
                ...
                if (c.p.sortable.options)
                    ...
                    c.p.sortable = {update: c.p.sortable};
                if (e.start) {
                    var g = e.start;
                        ...
                        a = b.extend({drag: function(a) {
                                return b.extend({start: function(e, d) {
                                        ...
                                        for (f = 0; f < b.data(c, "dnd").connectWith.length; f++)
                                            b(b.data(c, "dnd").connectWith[f]).jqGrid("getGridParam",
