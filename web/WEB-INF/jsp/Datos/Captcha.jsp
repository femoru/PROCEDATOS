<%-- 
    Document   : Captcha
    Created on : 14-jun-2012, 9:47:36
    Author     : rquintero
--%>
...
<%
    ...
    try {
        ...
        int charsToPrint = 3;
        int width = request.getParameter("width") != null ? Integer.parseInt(request.getParameter("width")) : 80;
...
//System.out.println("x=" + x + " height=" + height + " charDim=" + charDim + " y=" + y + " advance=" + maxAdvance + " fontHeight=" + fontHeight + " ascent=" + fontMetrics.getAscent());
        ...
        request.getSession().setAttribute("key", finalString.toString());
